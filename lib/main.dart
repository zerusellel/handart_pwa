...
class Item {
  ...
  Map<String, dynamic> toJson() => {
    ...
    'imageUrl': imageUrl, 'phone': phone, 'whatsapp': whatsapp, 'telegram': telegram
  };
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Wrap(
                            ...
                            children: [
                              ElevatedButton.icon(
                                onPressed: () => _open(i.whatsapp),
                                icon: const Icon(Icons.chat),
                                label: const Text('WhatsApp'),
                              ),
                              ElevatedButton.icon(
                                onPressed: () => _open(i.telegram),
                                icon: const Icon(Icons.send),
                                label: const Text('Telegram'),
                              ),
                              ElevatedButton.icon(
                                onPressed: () => _open(i.phone),
                                icon: const Icon(Icons.call),
                                label: const Text('Call'),
                              ),
                              IconButton(
                                tooltip: 'Save',
                                onPressed: () => _toggleFav(i.id),
